...
class StockCard extends Component {
  info = async () => {
    ...
    let response = await axios.get(
      // `https://api.iextrading.com/1.0/stock/${this.props.data.symbol}/chart/dynamic`
      `https://financialmodelingprep.com/api/v3/historical-chart/4hour/${this.props.data.symbol}?apikey=aab6fab8b982956be313a36d56ed0e09`
    );
        ...
        {props && (
          <Col span={8}>
            ...
            >
              ...
              {props.latestPrice} $
              <br />
              <Text strong>Invest Amount: </Text>
              ...
              <div style={{ textAlign: "right" }}>
                <Text style={{ fontSize: 10 }}>{getTodayDate()} </Text>
              </div>
            </Card>
          </Col>
        )}
